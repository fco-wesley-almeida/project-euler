<template>
  <v-layout wrap justify-center align-center>
    ...
    <v-snackbar v-model="snackbar" color="success" bottom right :timeout="2000">Salvo com sucesso!</v-snackbar>
  </v-layout>
</template>
    ...
    tutorialHasChanged() {
      if (this.tutorial && this.originalTutorial) {
        return (
          ...
          this.tutorial.date.toDate().toISOString() !==
            this.originalTutorial.date.toDate().toISOString()
        );
      }
      return false;
    },
